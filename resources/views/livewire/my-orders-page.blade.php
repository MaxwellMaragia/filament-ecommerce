    ...
    <section class="border-b container flex-grow lg:flex lg:flex-row lg:py-10 max-w-[1200px] mx-auto py-5 w-full">
        ...
        <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
            <div class="gap-3 max-w-[1200px] mx-auto py-5">
                <h1 class="text-2xl w-full font-semibold">Your orders history</h1>
            </div>
                                ...
                                @foreach($orders as $order)
                                    ...
                                    <tr class="odd:bg-white even:bg-gray-100 dark:odd:bg-slate-900 dark:even:bg-slate-800" wire:key="{{ $order->id }}">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                                            <a href="/my-orders/{{ $order->id }}" class="bg-purple-700 text-white py-2 px-4 hover:bg-blue-500">View Details</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
