        ...
        @if($cart_items)
            ...
            <div class="max-lg:max-w-lg max-lg:mx-auto">
                ...
                <button
                    ...
                    class="bg-violet-900 py-4 px-6 bg-indigo-600 text-white font-semibold text-lg w-full text-center transition-all duration-500 hover:bg-indigo-700 ">Checkout</button>
            </div>
        @endif
    </div>
</section>
