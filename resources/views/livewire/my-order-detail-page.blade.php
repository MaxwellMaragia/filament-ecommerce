<x-slot name="head">
    <title>{{ env('APP_NAME').' - Order details' }}</title>
...
<div>
    ...
    <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
        <div class="gap-3 max-w-[1200px] mx-auto py-5">
            <h1 class="text-2xl w-full font-semibold">Order details</h1>
        </div>
        ...
        <div class="flex flex-col md:flex-row gap-4 mt-4">
            <div class="md:w-3/4">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <th class="text-left font-semibold px-4 py-2">Price</th>
                                <th class="text-left font-semibold px-4 py-2">Quantity</th>
                                <th class="text-left font-semibold px-4 py-2">Total</th>
                            </tr>
                            </thead>
                            <tbody>
                            @foreach($order_items as $item)
                                <tr wire:key="{{ $item->id }}">
                                    ...
                                    <td class="py-4 px-4"> <a href="/products/{{ $item->product->slug }}" class="font-semibold text-blue-900 hover:underline">{{ $item->product->name }}</a></td>
                                    <td class="py-4 px-4">{{ Number::currency($item->unit_amount, 'Ksh') }}</td>
                                    <td class="py-4 px-4 text-center">{{ $item->quantity }}</td>
                                    <td class="py-4 px-4">{{ Number::currency($item->total_amount, 'Ksh') }}</td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
                ...
                <div class="bg-white overflow-x-auto rounded-lg shadow-md p-6 mb-4">
                    ...
                    <div class="flex justify-between items-center">
                        <div>
                            <p>{{ $address->street_address }}, {{ $address->city }}, Kenya, {{ $address->zip_code }}</p>
                        </div>
                        <div>
            ...
            <div class="md:w-1/4">
                <div class="bg-white rounded-lg shadow-md p-6">
                    ...
                    <div class="flex justify-between mb-2">
                        <span>Shipping</span>
                        <span>{{ optional($order->carrier)->name }}</span>
