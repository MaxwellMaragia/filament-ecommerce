                        ...
                        <div class="lg:pl-20">
                            ...
                            <div class="flex-1 mt-6">
                                ...
                                <div class="flex flex-wrap">
                                    <a class="bg-green-900 rounded-lg text-white text-xs text-center self-center px-2 py-2 my-2 mx-1">Whatsapp <i class="fab fa-whatsapp ml-1"></i></a>
                                    <a class="bg-blue-700 rounded-lg text-white text-xs text-center self-center px-2 py-2 my-2 mx-1">Facebook <i class="fab fa-facebook ml-1"></i></a>
                                    <a class="bg-blue-400 rounded-lg text-white text-xs text-center self-center px-2 py-2 my-2 mx-1">Twitter <i class="fab fa-twitter ml-1"></i></a>
                                    <a class="bg-black rounded-lg text-white text-xs text-center self-center px-2 py-2 my-2 mx-1">Copy <i class="fa fa-paperclip ml-1"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
